    ...
    run: async ({ interaction }) => {
        ...
        const painel = new ActionRowBuilder().addComponents(
            new StringSelectMenuBuilder()
                .setCustomId('painel_3')
                .setPlaceholder('Clique')
                .addOptions(
                    {
                        label: '📁 Suspeitos Registrados',
        ...
        .setDescription(`> Este canal tem como finalidade exclusiva o registro de suspeitos investigados.\n\n > Caso não faça parte do quadro da diretoria da divisão de inteligência não crie registros desnecessários. Agradecemos pela sua compreensão.`)
